---
title: 规范
description: Agent QC v0.1.0 Lime 草案规范。
---

# 规范

Agent QC v0.1.0 是面向 Lime 的草案标准，用于定义证据驱动的测试计划、门禁、qcloop 批次、判定和报告。

它标准化的是 Agent 测试 Lime 时应产生的质量控制事实；不拥有 Lime 代码、qcloop 执行、证据存储、UI 投影或人工评审策略。
...
| Object | 用途 |
| --- | --- |
| `qc_plan` | 一次 Lime 改动、路径或发布风险的测试计划。 |
