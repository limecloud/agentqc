---
title: 来源索引
description: Agent QC v0.2.0 使用的可追踪来源。
---

# 来源索引

Agent QC v0.2.0 来自本地项目检查和公开文档。这里的本地仓库是案例，不是规范依赖。
...
| `/Users/coso/Documents/dev/js/claudecode` | 不完整本地快照；可参考 shell/spec 与 permission-tool 表面，不足以推断 CI。 |
...
| 来源 | 用途 |
| --- | --- |
| `https://agentskills.io/specification.md` | 面向 Agent 的 Markdown/frontmatter/progressive disclosure 风格。 |
| `https://agentskills.io/skill-creation/evaluating-skills.md` | eval-driven iteration 与 assertion grading 模式。 |
