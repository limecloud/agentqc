---
title: Source index
description: Traceable sources used by Agent QC v0.3.0.
---

# Source index

Agent QC v0.3.0 is derived from local project inspection plus public documentation. Local repositories are case studies, not normative dependencies.
...
| `/Users/coso/Documents/dev/js/claudecode` | Partial local source snapshot; useful for Ink TUI, remote bridge, SDK stream, command, skill/plugin, and permission-tool surfaces; not enough for CI conclusions. |
...
| Source | Use |
| --- | --- |
| `https://agentskills.io/specification` | Markdown/frontmatter/progressive disclosure style for Agent-facing standards. |
| `https://agentskills.io/skill-creation/evaluating-skills` | Eval-driven iteration and assertion-grading pattern. |
...
| OpenClaw local `ui/package.json` and `extensions/qa-lab/package.json` | Browser-playwright WebUI testing and QA Lab scenario/report runtime. |
| Hermes local `ui-tui/package.json` and `web/package.json` | TUI Vitest package and Vite/React web dashboard shape. |
