...
| Benchmark eval | Runtime/prompt/tool/context candidate 是否变好 | frozen dataset、trial trajectories、reward details、baseline/candidate delta | release safety 或 P0 QC pass |
